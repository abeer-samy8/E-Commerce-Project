...
@section("content")
<form enctype='multipart/form-data' method='post' action='{{route("slider.index")}}'>
    @csrf
            ...
            <div class="m-portlet__body">
                <div class="m-form__section m-form__section--first">
                    <div class="form-group m-form__group row">
                        ...
                        <div class="col-lg-6">
                            <input autofocus='true' value='{{ old("title") }}' type="text" class="form-control m-input"
                    ...
                    <div class="form-group m-form__group row">
                        ...
                        <div class="col-lg-6">
                            <input autofocus='true' value='{{ old("subtitle") }}' type="text"
                    ...
                    <div class="form-group m-form__group row">
                        ...
                        <div class="col-lg-6">
                            <input autofocus='true' value='{{ old("image") }}' type="file" class="form-control m-input"
                                placeholder="Enter image" name="image" id="image">
                    ...
                    <div class="form-group m-form__group row">
                        ...
                        <div class="col-lg-6">
                            <input autofocus='true' value='{{ old("button_text") }}' type="text"
                                class="form-control m-input" name="button_text" id="button_text"
                                placeholder="Enter button_text">
                            <span class="m-form__help">Please enter button text</span>
                        </div>
                    </div>
                    ...
                    <div class="m-form__group form-group row">
                        <label class="col-lg-3 col-form-label">New Window:</label>
                        <div class="col-lg-6">
                            <div class="m-checkbox-inline">
                                <label class="m-checkbox">
                                    <input value='1' {{old('new_window')?"checked":""}} type="checkbox" name="new_window" />
                                    New Window
                                    <span></span>
                                </label>
                            </div>
                ...
                <div class="m-form__actions m-form__actions">
                    <div class="row">
                        ...
                        <div class="col-lg-6">
                            ...
                            <a href="{{asset('admin/slider')}}" class="btn btn-secondary"> Cancel</a>
                        </div>
                    </div>
                </div>
            </div>

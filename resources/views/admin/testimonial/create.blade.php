...
<div class="m-portlet m-portlet--mobile">
    <form enctype='multipart/form-data' method="post" action='{{route("testimonial.index")}}'>
        @csrf
        <div class='m-form'>
            <div class="m-portlet__body">
                <div class="m-form__section m-form__section--first">
                    <div class="form-group m-form__group row">
                        ...
                        <div class="col-lg-6">
                            <input id="title" value="{{ old('name') }}" name="name" placeholder="name"
                    ...
                    <div class="form-group m-form__group row">
                        ...
                        <div class="col-lg-6">
                            <textarea id="details" rows='8' name="subject" placeholder="Enter Detaila"
                    ...
                    <div class="form-group m-form__group row">
                        ...
                        <div class="col-lg-6">
                            <input id="title" value="{{ old('role') }}" name="role" placeholder="role"
                                class="form-control" type="text">
                        </div>
                    </div>
                ...
                <div class="m-form__actions m-form__actions">
                    <div class="row">
                        ...
                        <div class="col-lg-6">
                            ...
                            <a href="{{asset('admin/testimonial')}}" class="btn btn-secondary">Cancel</a>
                        </div>
                    </div>
                </div>
            </div>

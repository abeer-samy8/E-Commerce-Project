                                        ...
                                        <div class="m-dropdown__header m--align-center"
                                            ...
                                            <div class="m-card-user m-card-user--skin-dark">
                                                <div class="m-card-user__pic">
                                                    <img src="{{auth()->user()->image?asset('storage/user-images/'.auth()->user()->image):asset('metronic/assets/app/media/img/users/user.png')}}"
                                                        ...
                                                        <a href="{{route('profile.edit')}}" class="m-nav__link">
                                                            ...
                                                            <span class="m-nav__link-title">
                                                                <span class="m-nav__link-wrap">
                                                                    <span class="m-nav__link-text">Personal Profile</span>
                                                                </span>
                                                            </span>
                                                        </a>
                                                    </li>
                                                    ...
                                                    <li class="m-nav__item">
                                                        <form method="POST" action="{{ route('logout') }}">
                                                            ...
                                                            <a href="route('logout')"
                                                                ...
                                                                class="btn m-btn--pill btn-secondary m-btn m-btn--custom m-btn--label-brand m-btn--bolder">{{trans('Logout')}}</a>
